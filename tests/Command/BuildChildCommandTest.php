...
class BuildChildCommandTest extends PHPUnit_Framework_TestCase {
    ...
    public function run_with_test_branch () {
        ...
        $repositoryMock->expects($this->at(0))
                       ->method('getMainBranch')
                       ->will($this->returnValue($this->createRepositoryMainBranchMock('testBranch')));
    ...
    public function run_with_master_branch_without_other_branches () {
        ...
        $repositoryMock->expects($this->any())
                       ->method('getMainBranch')
                       ->will($this->returnValue($this->createRepositoryMainBranchMock('master')));
    ...
    public function run_with_major_branch_without_other_branches () {
        ...
        $repositoryMock->expects($this->any())
                       ->method('getMainBranch')
                       ->will($this->returnValue($this->createRepositoryMainBranchMock('1')));
    ...
    public function run_with_minor_branch () {
        ...
        $repositoryMock->expects($this->any())
                       ->method('getMainBranch')
                       ->will($this->returnValue($this->createRepositoryMainBranchMock('0.2')));
    ...
    private function createRepositoryMainBranchMock ($branchName) {
        $branchMock = $this->getMockBuilder(Branch::class)
                           ->disableOriginalConstructor()
                           ->getMock();
